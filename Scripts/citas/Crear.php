...
<form action="procesar.php" method="POST">
        <div class="mb-3 mt-3">
          ...
          <input type="date" class="form-control" id="name" placeholder="Inserte nombre" name="fecha">
        </div>
        <div class="mb-3 mt-3">
          <label for="name" class="form-label">Hora:</label>
          <input type="time" class="form-control" id="name" placeholder="Inserte nombre" name="hora">
        </div>
