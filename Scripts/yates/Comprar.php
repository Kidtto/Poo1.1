...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-6">
                <img class="img" src="../../<?php echo $yate['photo']; ?>" alt="">
            </div>
            <div class="col-6">
            <ul class="list-group">
                <li class="list-group-item">Modelo: <?php echo $yate['model']; ?></li>
                <li class="list-group-item">Precio: $<?php echo $yate['price']; ?></li>
                <li class="list-group-item">Información: <?php echo $yate['information']; ?></li>
                <li class="list-group-item">Marca: <?php echo $yate['brand']; ?></li>
            </ul>
