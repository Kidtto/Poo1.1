<?php
include '../../Scripts/citas/Citas.php';
...
<div class="offcanvas offcanvas-end text-bg-dark" id="demo">
  ...
  <ul class="list-group ">
    ...
    <a class="btn" href="../../Scripts/autentificacion/cerrar_sesion.php"><li class="list-group-item bg-danger text-white">Cerrar Sesion</li></a>
  </ul>
  </div>
</div>
